...
# This ensures the script works in any environment: local, GitHub Actions, etc.
...
if __name__ == "__main__":
    snapshot_file = _path('latest_snapshot.json')
    kb_file       = _path('macro_regimes_kb.json')
    output_file   = _path('morning_briefing.json')
    ...
    print(f"\nBriefing exported to {output_file}")
